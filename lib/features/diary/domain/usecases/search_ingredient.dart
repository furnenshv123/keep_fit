...
class SearchIngredient
    extends Usecase<List<IngredientEntity>, SearchIngredientParams> {
  SearchIngredient({required IngredientRepository ingredientRepository})
      : _ingredientRepository = ingredientRepository;

  final IngredientRepository _ingredientRepository;
  Future<Either<Failure, List<IngredientEntity>>> call(
      SearchIngredientParams params) async {
