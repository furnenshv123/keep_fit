...
class CalendarWidget extends StatefulWidget {
  CalendarWidget({super.key, required this.bloc});
  CalendarBloc bloc;
  @override
            ...
            TableCalendar(
              ...
              onDaySelected: (selectedDay, focusedDay) {
                if (!isSameDay(_selectedDay, selectedDay)) {
                  ...
                  if (focusedDay.isBefore(DateTime.now()) || focusedDay.day == DateTime.now().day) {
                    context
                        .read<CalendarBloc>()
                        .add(CalendarDaySelected(selectedDay: selectedDay));
          ...
          Container(
            ...
            child: Text(
              ...
              style: const TextStyle(
                  color: Colors.white, fontFamily: "Hanken", fontSize: 25),
            ),
            width: 40,
            height: 40,
            decoration: const BoxDecoration(
                color: AppColors.defaultDayColor, shape: BoxShape.circle),
          ),
          const SizedBox(
            height: 4,
          ),
      ...
      child: Column(
        children: [
          Container(
            ...
            height: 40,
            decoration: const BoxDecoration(
                color: AppColors.selectedDayColor, shape: BoxShape.circle),
          ),
          const SizedBox(
            height: 5,
          ),
          Container(
            ...
            height: 5,
            decoration: const BoxDecoration(
                shape: BoxShape.circle, color: AppColors.selectedDayColor),
            child: null,
          )
        ],
      ),
